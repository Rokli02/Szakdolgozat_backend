...
public interface UserseriesRepository extends PagingAndSortingRepository<Userseries, Long> {
  ...
  Optional<Userseries> findByUserAndSeriesOptional(User user, Series series);
}
